...
using Shouldly;
using Xunit;
using AutomaticAcceptanceTest.Sessions;

namespace AutomaticAcceptanceTest.Tests.Sessions
{
    public class SessionAppService_Tests : AutomaticAcceptanceTestTestBase
    {
